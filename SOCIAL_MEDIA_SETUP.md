...
## Brand Identity (use across all platforms)
...
Use these prompts in any AI image generator (Midjourney, DALL·E 3, Adobe Firefly, Ideogram, Stable Diffusion).

---

### Option A — Lettermark (recommended for profile photo)

> Minimal flat logo. A single bold letter **"D"** in clean white, centered on a solid **#3aaa6a green** square background. The "D" uses a modern geometric sans-serif typeface — thick strokes, rounded terminals, no serifs. The letter is perfectly centered with generous padding on all sides. The inside of the "D" has a subtle open book shape cut into the counter, formed by two small white diagonal lines suggesting an open book. Flat design, no gradients, no shadows, no textures, no effects. Pure vector-style. Square 1:1 format. Suitable for a social media profile icon.
...
### Option C — Icon with Arabic feel

> Flat minimal logo icon. A stylized open book shape in white, the right page curving upward like a rising spark or flame, symbolizing knowledge and ambition. Solid **#3aaa6a green** background, perfect square 1:1. Below the book icon, the word **"درسي"** in clean white modern Arabic typeface (kufi-inspired, geometric, no calligraphic flourishes). Centered composition, generous padding, no gradients, no shadows, no 3D effects. Vector flat design style.
...
- Always generate at **1024×1024 px minimum**, then upscale to 2000×2000 px
- Ask the AI to regenerate 4 variations and pick the cleanest one
- Avoid asking for text if the tool struggles with Arabic — add Arabic text in Canva/Figma afterward
- Export as **PNG with transparent background** for the wordmark version
...
> A wide banner showing Moroccan students studying with the tagline **"درسي — تعلّم، تقدّم، تفوّق"** overlaid on a clean green gradient.
> - Facebook/LinkedIn banner: **1640×856 px**
> - TikTok background: **1080×1920 px**
> - Snapchat Public Profile banner: **1080×360 px**
...
```
درسي هي المنصة التعليمية الرقمية الأولى المصممة خصيصاً للطلاب المغاربة.

توفر درسي:
✅ دروس PDF وفيديوهات مطابقة للمنهج الرسمي المغربي
✅ تمارين وامتحانات لكل المستويات (إعدادي، ثانوي، جذع مشترك، باكالوريا)
✅ متابعة تقدّمك الدراسي في الوقت الفعلي
✅ أستاذة معتمدون يمكنك التواصل معهم مباشرة
✅ تقويم مدرسي وأحداث التربية الوطنية
✅ مجاني بالكامل — مع خطط Pro و Premium للمزيد
...
✅ Des professeurs certifiés accessibles directement
...
| Highlight Name (AR/FR) | Content |
|------------------------|---------|
| 📖 دروس / Cours | Subject preview clips |
| 🎯 الباك / Bac | BAC-specific tips and resources |
| 📝 تمارين / Exos | Exercise walkthroughs |
| 👨‍🏫 أساتذة / Profs | Teacher spotlight reels |
| 🏆 طلاب / Élèves | Student testimonials |
| ℹ️ عن درسي / À propos | Platform walkthrough |
...
*(Alternative)*
```
🎓 Cours Bac & Brevet Maroc 🇲🇦
📚 درسي — تعلّم وتفوّق
```

## TikTok Content Strategy (post types to plan)

| Format | Description | Frequency |
|--------|-------------|-----------|
| **Quick lesson tip** | 30–60 sec explanation of one concept | 3–4×/week |
| **Exam countdown** | Countdown to BAC/Brevet with tips | Seasonal |
| **Study motivation** | Relatable Moroccan student humor | 2×/week |
...
**Arabic set:**
```
#الباكالوريا #البريفي #المغرب #الطلاب_المغاربة #درسي #تعلم_معنا #باك2025 #مراجعة #دروس_مجانية
```
...
```
#درسي #Bac2025 #المغرب🇲🇦 #BacMaroc #الباكالوريا #EtudiantsMarocains #دروس #Révisions
```
...
## Account / Public Profile Creation Fields
...
- [ ] Add website link
- [ ] Create first **Snap** (can be a welcome video)
...
| **Best post times** | 7–9pm (Moroccan time) | 6–9pm | 4–8pm | 3–7pm |
| **Content format** | Text + images + links | Reels + carousel | Short video | Stories + Spotlight |
| **Post language** | AR + FR | AR + FR | Darija + FR | Darija |

---

# First Week Content Plan (copy-paste ready)

## Post 1 — Launch Announcement (all platforms)
...
## Post 3 — Social Proof / Motivational
