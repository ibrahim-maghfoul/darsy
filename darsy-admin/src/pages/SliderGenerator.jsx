...
const SliderGenerator = () => {
    ...
    const generatePdf = async () => {
        ...
        try {
            ...
            pdf.text('Darsy Educational Platform', pageWidth / 2, pageHeight / 2 - 20, { align: 'center' });
            
            pdf.setTextColor(100, 100, 100);
            pdf.setFontSize(16);
            pdf.setFont('helvetica', 'normal');
            const introText = "Darsy is a next-generation online learning ecosystem designed to empower students across Morocco. By combining structured curricula, real-time collaboration, and engaging gamification, Darsy bridges the gap between traditional education and modern digital accessibility.";
            ...
            pdf.save('Darsy_Presentation.pdf');
        } catch (e) {
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24, padding: '20px 24px', background: 'linear-gradient(135deg, var(--green) 0%, #1e6e44 100%)', borderRadius: 16, color: 'white', boxShadow: '0 4px 20px rgba(58,170,106,0.2)' }}>
                ...
                <div style={{ flex: 1 }}>
                    ...
                    <p style={{ margin: '4px 0 0', fontSize: '0.85rem', opacity: 0.9 }}>
                        Generate 1792x1024 (16:9) visualization posters for all Darsy platform functionalities (via Infip).
                    </p>
                </div>
                <button
                    onClick={generatePdf}
                                ...
                                <div style={{ flex: '1 1 350px', background: '#f1f5f9', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, position: 'relative' }}>
                                    {result.url ? (
                                        <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 12 }}>
                                            ...
                                            <a 
                                                href={result.url} 
                                                download={`darsy-slider-${item.id}.png`}
