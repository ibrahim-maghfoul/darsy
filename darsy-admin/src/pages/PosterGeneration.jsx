...
const PosterGeneration = () => {
    ...
    const [darsyCorner, setDarsyCorner] = useState('top-right');
    ...
    const generateSocialCaption = async () => {
        ...
        try {
            ...
            const response = await makeLLMRequest([
                {
                    role: 'system',
                    content: `You are a social media expert for Darsy, an educational platform for Moroccan students. Write a single social media caption in ${captionLang}. Include 3-5 relevant emojis and end with 5-8 hashtags. No JSON, no markdown — plain text only. Max 200 characters before the hashtags.`
                },
                {
                    role: 'user',
                                ...
                                {posters.map((entry, i) => (
                                    <div
                                        ...
                                        onClick={() => {
                                            ...
                                            setCompositedUrl('');
                                            applyOverlays(entry, showDarsy, showLogo, logoCorner, darsyCorner);
                                        }}
                                        style={{
                    ...
                    <div className="cc-poster-layout">
                        ...
                        <div className="cc-poster-preview">
                            ...
                            <div className="pg-footer-btns" style={{ marginTop: 12 }}>
                                ...
                                <button className="pg-btn pg-btn-ghost" onClick={() => download(compositedUrl || selectedPoster?.url, `darsy-${Date.now()}.png`)} disabled={!compositedUrl && !selectedPoster}>
