...
const getCinematicSystemPrompt = (topic) => {
    ...
    return `
You are a graphic design image prompt generator for Darys School (darsyschool.com).
...
- "darsyschool.com" — absolute bottom center, medium sans-serif
...
const GhostApiTester = () => {
    ...
    const downloadImage = (url, idx) => {
        ...
        a.href = url; a.download = `darsy-ghost-${Date.now()}-${idx + 1}.png`;
                    ...
                    <div style={{ background: 'linear-gradient(135deg,#f0fdf4,#dcfce7)', borderRadius: 16, border: '1px solid #bbf7d0', padding: 16 }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 5, marginBottom: 12 }}>
                            {[
                                ...
                                { zone: 'Mid-below ctr', text: '"darsyschool.com"', note: 'reflection / trail · optional subtext' },
                            ].map(a => (
