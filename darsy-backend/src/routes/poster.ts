...
router.post('/save-session', async (req: Request, res: Response) => {
    try {
        ...
        const sessionDir = path.join(process.cwd(), '../darsy-admin/public/data', 'content-sessions', topicId);
...
router.get('/sessions', (_req: Request, res: Response) => {
    try {
        const sessionsDir = path.join(process.cwd(), '../darsy-admin/public/data', 'content-sessions');
...
router.post('/save-poster-image', async (req: Request, res: Response) => {
    try {
        ...
        const postersDir = path.join(process.cwd(), '../darsy-admin/public/data', 'posters');
